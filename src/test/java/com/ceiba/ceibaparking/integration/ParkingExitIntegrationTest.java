...
/**
 * Prueba de integración de la funcionalidad registro de salida del parqueo.
 * 
...
public class ParkingExitIntegrationTest {
	/**
	 ...
	 */
	private static final String SERVICE_URL = "http://localhost:8080/parkingRecordService/registerParkingExit";

	/**
	 * Prueba de integración de la funcionalidad de registro de salida de parqueo.
	 * 
	 * @author nelson.laverde
	 * @date Feb 5, 2019
	 ...
	 */
	@Test
	public void successRegisterParkingExit() throws JsonProcessingException {

		VehicleTestDataBuilder vehicleTestDataBuilder = new VehicleTestDataBuilder();
		VehicleDomain vehicleDomain = vehicleTestDataBuilder.withLicensePlate("NDF39A").build();
